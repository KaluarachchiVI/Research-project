...
def health() -> dict:
    """
    Lightweight health endpoint so frontends and launchers can verify that the
    Intent-Lock backend is reachable.
    """
    try:
        # Touch the model and DB to ensure basic initialization worked.
        _ = model is not None
        return {"status": "ok"}
